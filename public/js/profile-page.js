...
function saveCollegeInfo(){
    ...
    var inputSemister = document.getElementById("inputSemister").value;
    ...
    new Promise ( (resolve , reject ) => {$.ajax({
        ...
        if(!checkEmpty(inputSemister)){
            document.getElementById("inputSemister").value = null
            document.getElementById("inputSemister").placeholder = inputSemister;
        }
